    ...
    <>
      ...
      <nav className="navbar">
        <div className="navbar-logo">
          <img src="/public/images/jl.png" alt="Logo Univers Yuna" />
      ...
      {showArchives ? (
        ...
        <>
          {/* ------------------- LOGOS & TITRE ------------------- */}
          <div>
            <img src="/public/images/jl.png" className="logo" alt="Vite logo" />
            <img src="/public/images/logo.png" className="logo react" alt="React logo"/>
          </div>
          <h1>Univers Yuna</h1>
